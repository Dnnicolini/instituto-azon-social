...
<html lang="pt-BR">
    <head>
        ...
        <x-inertia::head>
            ...
            <meta data-inertia="og:image" property="og:image" content="{{ $seo['image'] ?? url('/azon-social-logo.png') }}">
            ...
            <meta data-inertia="twitter:image" name="twitter:image" content="{{ $seo['image'] ?? url('/azon-social-logo.png') }}">
