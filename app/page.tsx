...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><div className="footer-brand"><span className="brand-mark"><img src="/azon-social-logo.png" alt="" /></span><div><strong>Azon Social</strong><p>Ancestralidade, cuidado e transformação social.</p></div></div><div><strong>Navegue</strong><a href="#instituto">O Instituto</a><a href="#projetos">Projetos</a><a href="#noticias">Notícias</a><a href="/eventos">Eventos</a><a href="#transparencia">Transparência</a></div><div><strong>Redes</strong><a href="https://www.instagram.com/azon.social/" target="_blank" rel="noreferrer">@azon.social ↗</a><a href="https://www.instagram.com/azonlegidan/" target="_blank" rel="noreferrer">@azonlegidan ↗</a></div><p className="copyright">© {new Date().getFullYear()} Instituto Azon Social</p></footer>
    </main>
  );
}
