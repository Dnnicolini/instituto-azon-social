    ...
    <main>
      <header className="site-header">
        ...
        <nav className={menuOpen ? "nav open" : "nav"} aria-label="Navegação principal">
          {[["O Instituto","#instituto"],["Projetos","#projetos"],["Notícias","#noticias"],["Eventos","/eventos"],["Transparência","#transparencia"]].map(([label, href]) => <a key={href} href={href} onClick={() => setMenuOpen(false)}>{label}</a>)}
      ...
      <section className="agenda section" id="agenda"><div><p className="eyebrow">Eventos e inscrições</p><h2>Participe das nossas ações</h2></div><div className="agenda-empty"><span className="calendar-icon">+</span><div><h3>Inscrições, encontros e atividades em um só lugar.</h3><p>Veja oportunidades abertas, próximos eventos e a memória das ações realizadas.</p></div><a className="button button-outline" href="/eventos">Ver todos os eventos →</a></div></section>
      ...
      <section className="contact section" id="contato">
        <div className="contact-copy"><p className="eyebrow light">Entre em contato</p><h2>Vamos construir juntos?</h2><p>Envie sua mensagem para saber mais sobre projetos, parcerias, voluntariado e formas de apoio.</p><div className="contact-details"><a href="tel:+5521951015058">(21) 95101-5058</a><a href="mailto:instituto.azonsocial@gmail.com">instituto.azonsocial@gmail.com</a></div><p className="location">Sepetiba • Rio de Janeiro — RJ</p></div>
      ...
      <footer><div className="footer-brand"><span className="brand-mark"><img src="/azon-social-logo.png" alt="" /></span><div><strong>Azon Social</strong><p>Ancestralidade, cuidado e transformação social.</p></div></div><div><strong>Navegue</strong><a href="#instituto">O Instituto</a><a href="#projetos">Projetos</a><a href="#noticias">Notícias</a><a href="/eventos">Eventos</a><a href="#transparencia">Transparência</a></div><div><strong>Contato</strong><a href="tel:+5521951015058">(21) 95101-5058</a><a href="mailto:instituto.azonsocial@gmail.com">instituto.azonsocial@gmail.com</a><a href="https://www.instagram.com/azon.social/" target="_blank" rel="noreferrer">@azon.social ↗</a></div><p className="copyright">© {new Date().getFullYear()} Instituto Azon Social</p></footer>
    </main>
  );
}
